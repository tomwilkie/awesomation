"""Python daemonization code."""

# Taken from http://www.jejik.com/files/examples/daemon.py
...
class Daemon(object):
  ...
  """
  def __init__(self, pidfile, daemonize=True, stdin='/dev/null', stdout='/dev/null', stderr='/dev/null'):
    self.stdin = stdin
    self.stdout = stdout
    self.stderr = stderr
